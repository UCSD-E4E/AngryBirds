cmd_scripts/unifdef := gcc -Wp,-MD,scripts/.unifdef.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer   -I/build/buildd/linux-src/tools/include  -o scripts/unifdef scripts/unifdef.c  
