cmd_scripts/pnmtologo := gcc -Wp,-MD,scripts/.pnmtologo.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer   -I/build/buildd/linux-src/tools/include  -o scripts/pnmtologo scripts/pnmtologo.c  
